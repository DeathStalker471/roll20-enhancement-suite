...
if(doesBrowserNotSupportResponseFiltering()) {
  ...
  const request_blocker = (request) => {
    ...
    else if(request.url.includes("cdn.roll20.net/vtt/legacy/production/20250930/vtt.bundle")) {
      if(!request.url.includes("cdn.roll20.net/vtt/legacy/production/20250930/vtt.bundle?n")) {
        cancel = true;
      }
    }
  ...
  const redirect_targets = [
    ...
    "https://cdn.roll20.net/vtt/legacy/production/20250930/vtt.bundle",
  ];
